...
def main():
    ...
    with st.form("my_form"):
        ...
        if submitted:
            st.write("Result")
            data = fetch(session, f"http://192.168.1.10:3000/predict?params=0 1 1 1 1 0.052631579 0 0 0.04 0 0 0.005289629 0.005289629 0 0 0.213284583 0.005747126 0.005813953 0.108866442 0 1")
            if data:
